...
- 落地记录分侧配置 (记录开关/格式/TXT时间戳间隔), 共用 basedir 在开始/停止按钮旁; 自动创建时间戳文件夹 `2026-09-10_11-20-56`, 内含 `M.bin/M.txt/W.bin/W.txt`
